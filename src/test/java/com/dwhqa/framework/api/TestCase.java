...
public class TestCase {
    ...
    public TestCase(String baseUri, String testId, String group, String method, String endpoint, String pathParams, String queryParams, String headers, String bodyFile, String expStatus, String expJsonPathAsserts, String expSchema)
    {
        ...
        this.expJsonPathAsserts=expJsonPathAsserts;
        this.expSchema=expSchema;
    }
    ...
    public String bodyFile(){return bodyFile;}
    public int expStatus(){return Integer.parseInt(expStatus);}
    public String expJsonPathAsserts(){return expJsonPathAsserts;}
    public String expSchema(){return expSchema;}
}
