...
public class WireMockSupport {
    ...
    public static void start() {
        ...
        // --- Stubs for Product APIs ---
//        server.stubFor(get(urlEqualTo("/v1/products/SKU-1001"))
...
//
//        server.stubFor(post(urlEqualTo("/v1/inventory/adjust"))
//                .willReturn(aResponse()
//                        .withHeader("Content-Type", "application/json")
